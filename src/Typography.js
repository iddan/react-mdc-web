...
export const Typography = ({ className, ...rest } : ClassNamed) => (
  <span {...rest} className={classnames("mdc-typography", className)} />
);

export const Display4 = ({ className, ...rest } : ClassNamed) => (
  <span
    {...rest}
...
export const Display3 = ({ className, ...rest } : ClassNamed) => (
  <span
    {...rest}
...
export const Display2 = ({ className, ...rest } : ClassNamed) => (
  <span
    {...rest}
...
export const Display1 = ({ className, ...rest } : ClassNamed) => (
  <span
    {...rest}
...
export const Headline = ({ className, ...rest } : ClassNamed) => (
  <span
    {...rest}
...
export const Subheading2 = ({ className, ...rest } : ClassNamed) => (
  <span
    {...rest}
...
export const Subheading1 = ({ className, ...rest } : ClassNamed) => (
  <span
    {...rest}
...
export const Body2 = ({ className, ...rest } : ClassNamed) => (
  <span {...rest} className={classnames("mdc-typography--body2", className)} />
);

export const Body1 = ({ className, ...rest } : ClassNamed) => (
  <span {...rest} className={classnames("mdc-typography--body1", className)} />
);

export const Caption = ({ className, ...rest } : ClassNamed) => (
  <span
    {...rest}
...
export const Button = ({ className, ...rest } : ClassNamed) => (
  <span {...rest} className={classnames("mdc-typography--button", className)} />
);

export const AdjustMargin = ({ className, ...rest } : ClassNamed) => (
  <span
    {...rest}
